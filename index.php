...
<html>
	...
	<body>
		...
		<form method="post" action="index.php">
			<input type="text" name="username" maxlength="15" placeholder="Username" value="user007"/>
			<input type="text" name="password" maxlength="15" placeholder="Password" value="qwerty"/>
